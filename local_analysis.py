...
test_image_name = 'Black_Footed_Albatross_0002_55.jpg' #'Painted_Bunting_0081_15230.jpg'
test_image_label = 0 #15
...
load_model_dir = './saved_models/vgg19/2024-07-23_21-43-17/' #'./saved_models/vgg19/003/'
load_model_name = '10nopush0.6645.pth' #'10_18push0.7822.pth'
...
model_base_architecture = load_model_dir.split('/')[-2]
experiment_run = '/'.join(load_model_dir.split('/')[-1:])
